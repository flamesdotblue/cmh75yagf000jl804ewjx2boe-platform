      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button onClick={() => setOpen((v) => !v)} className="relative rounded-xl p-2 hover:bg-white/5 transition" aria-label="Notifications">
              <Bell size={18} />
            ...
            {open && (
              <div className="absolute right-0 mt-2 w-72 rounded-xl border border-neutral-800 bg-neutral-900/90 backdrop-blur p-3 text-sm">
                <div className="text-xs text-neutral-400 mb-2">Notifications</div>
                <div className="space-y-2">
                  <div className="rounded-lg bg-white/5 p-2">New chapter released: Crimson Shards Ch. 11</div>
                  <div className="rounded-lg bg-white/5 p-2">Reply to your comment on Neon Echo</div>
                  <div className="rounded-lg bg-white/5 p-2">Weekly picks are live</div>
                </div>
              </div>
            )}
          </div>
